...
AVAILABLE_CHECKINGS = sorted([ STABLE_BONDS_FLAG, COHERENT_BONDS_FLAG, TRAJECTORY_INTEGRITY_FLAG ])
# State all critical process failures, which are to be lethal for the workflow unless mercy is given
AVAILABLE_FAILURES = sorted(AVAILABLE_CHECKINGS + [ CORRECT_ELEMENTS, REFERENCE_SEQUENCE_FLAG, STABLE_INTERACTIONS_FLAG, LIGANDS_MATCH_FLAG, CHAINS_ANALYSIS ])
