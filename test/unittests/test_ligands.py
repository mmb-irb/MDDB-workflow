...
def test_generate_ligand_references():
    ...
    mwf_stc = Structure.from_file('../data/input/structures/cin_A000V_structure.pdb')
    ...
    for case in test_cases:
        ...
        assert found == case[2], f"Ligand {case[0]} found with CID {found} instead of {case[2]}."

    inchirefs = generate_inchi_references(inchimap, {}, ligand_references, 'inchiout.json')
    ...
    # Cleanup
    os.remove('cache_ligands.json')
    os.remove('inchiout.json')
