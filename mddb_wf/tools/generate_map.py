...
import numpy as np
from mddb_wf.utils.auxiliar import protein_residue_name_to_letter
from mddb_wf.utils.auxiliar import InputError, warn, load_json, save_json, request_pdb_data
from mddb_wf.utils.constants import REFERENCE_SEQUENCE_FLAG, NO_REFERABLE_FLAG, NOT_FOUND_FLAG
...
from mddb_wf.resources.covid_variants import covid_spike_variants
