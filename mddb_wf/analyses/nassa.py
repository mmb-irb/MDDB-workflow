...
from mddb_wf.tools.nassa_base import Base
from mddb_wf.tools.nassa_loaders import load_sequence
from mddb_wf.tools.nassa_loaders import load_serfile
from mddb_wf.utils.constants import NASSA_ANALYSES_CANALS, BLUE_HEADER, COLOR_END, CYAN_HEADER, GREEN_HEADER

from mddb_wf.utils.heatmaps_nassa import basepair_plot
from mddb_wf.utils.heatmaps_nassa import bconf_heatmap
from mddb_wf.utils.heatmaps_nassa import correlation_plot
from mddb_wf.utils.heatmaps_nassa import arlequin_plot
from mddb_wf.utils.bibitransformer_nassa import BiBiTransformer
from mddb_wf.utils.auxiliar import InputError
from mddb_wf.utils.nassa_file import generate_nassa_config
...
def workflow_nassa(
    ...
    if helical_par:
        ...
        actual_path = getcwd()
        # The workflow function is imported from mddb_wf to run the helical parameters analysis and do all the checks in each project directory
        # By this way, we are assuming that each project directory is an independent project or MD simulation
        from mddb_wf.mwf import workflow
