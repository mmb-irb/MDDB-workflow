...
def _iterate_protein_residues(universe, snapshots, frames_limit, lipid_group, accumulate_fn):
    ...
    for _ts in universe.trajectory[0:snapshots:frame_step]:
...
def aa_lipid_interactions(universe, snapshots, frames_limit, lipid_map):
    ...
    protein_residx, frame_count = _iterate_protein_residues(
        universe, snapshots, frames_limit, lipid_group, accumulate)
