...
GROMACS_CUSTOM_MASSES_FILEPATH = f'{RESOURCES_DIRECTORY_PATH}/{GROMACS_MASSES_FILENAME}'
...
AVAILABLE_CHECKINGS = [STABLE_BONDS_FLAG, COHERENT_BONDS_FLAG, TRAJECTORY_INTEGRITY_FLAG, CROSS_PBC_FLAG]
...
TRAJECTORY_TESTS = [STABLE_BONDS_FLAG, TRAJECTORY_INTEGRITY_FLAG, CROSS_PBC_FLAG]
...
NICE_NAMES = {
    ...
    CROSS_PBC_FLAG: 'Cross-PBC contacts test',
...
STANDARD_DUMMY_ATOM_NAMES = {'MW', 'LP1', 'DM*', 'EPW'}
